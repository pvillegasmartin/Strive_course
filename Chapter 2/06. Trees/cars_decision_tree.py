...
parameters = {'criterion':('gini', 'entropy'), 'max_depth':[2, 8]}
classifier = DecisionTreeClassifier() #criterion='gini', max_depth=3)
clf = GridSearchCV(classifier, parameters)
clf.fit(X_train, y_train)
best_parameters = clf.best_params_ # we see best parameters are criterion='gini' and max_depth=8
...
print(cv['test_score'].mean()) # accuracy mean of 0.966914714858887
'''
