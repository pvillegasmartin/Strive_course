...
def train(model, x, y, x_val, y_val, optimizer, criterion, epochs, device):
    ...
    for epoch in range(epochs):
        ...
        if (epoch + 1) % 2 == 0:
            ...
            print("Epoch: {}/{} \t Train Loss: {}, Test Loss: {}".format(epoch + 1, epochs, losses / x.shape[0],
                                                                         test_losses / x_val.shape[0]))
            print("\n")
...
train(model, x_train, y_train, x_val, y_val, opt, criterion=criterion, epochs=200, device=device)